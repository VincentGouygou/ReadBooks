...
<div class="box  ">
       ...
       <div class="flex ">
                ...
                <div  class="gradientinv milieuG flex10 silkserif    superBigFont bold ">
                ...
                <div  class="gradient milieuD silkserif  flex2 bigFont bold ">
                          <pre class="silkserif Font right">      Mets un titre   et des infos copiables vont apparaitre</pre>               
                        <pre class="silkserif Font right">  Ajoutes ton livre ! ! !  <button class="silkserif left Font " id="addbook">Go !!!</button></pre>
